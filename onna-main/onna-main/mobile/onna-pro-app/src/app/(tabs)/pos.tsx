    ...
    return (
        <SafeAreaView className="flex-1 bg-gray items-center pl-[7.5px] pr-[7.5px]" >
                ...
                <View className=" ">
                    ...
                    <View className=" mt-10 w-[385px] h-[25.75%] bg-white flex-column justify-center items-center rounded-[15px] gap-4 shadow-black shadow-2xl" >
                        <Text className="color-black text-[18.75px] font-Imedium text-center mt-[10px]">
                        Com base nos resultados, 
                        
                        <Text className="color-red-900 font-Imedium text-center text-[20.75px] font-bold " >há uma alta possibilidade de gravidez.</Text> Recomendamos que você procure um médico o mais rápido possível para confirmar e receber orientação adequada!
                        </Text>
                    </View>
                    ...
                    <View className="items-center mt-[20px]">
                        <Pressable className="w-[20%] h-[50px] bg-red-500 justify-center items-center rounded-[12.5px] border-red-500 border-[2px]" >
                            <Link href={"../q8"} >
